...
import { Bot, FileUp, Link as LinkIcon, Palette, UploadCloud } from "lucide-react"
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Textarea id="pitch" placeholder="Describe your company in a few sentences." />
              </div>
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-end">
                    ...
                    <div className="flex items-center gap-4">
                     ...
                     <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                             <Input id="color" placeholder="#3F51B5" className="max-w-xs" />
                             <div className="w-8 h-8 rounded-md border" style={{backgroundColor: '#3F51B5'}}></div>
                        </div>
                    </div>
                </div>
                ...
                <Card className="bg-muted/50">
                    ...
                    <CardContent className="space-y-4">
                        <Textarea rows={5} placeholder="Generate a brand brief from your details..." />
                        <Button className="w-full">Generate Brief</Button>
                    </CardContent>
                </Card>
              </div>
                ...
                <div className="space-y-4 pt-4 border-t">
                    ...
                    <div className="flex items-center gap-4 p-4 border border-dashed rounded-lg">
                        ...
                        <Button variant="outline" className="ml-auto">Upload CSV</Button>
                    </div>
                </div>
